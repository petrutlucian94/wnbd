...
#define WNBD_DISK_HANDLE_FROM_ADDR(PathId, TargetId, Lun) \
    ((1 << 24 | (PathId) << 16) | ((TargetId) << 8) | (Lun))
#define WNBD_DISK_HANDLE_PATH(Handle) (((Handle) >> 16) & 0xff)
#define WNBD_DISK_HANDLE_TARGET(Handle) (((Handle) >> 8) & 0xff)
#define WNBD_DISK_HANDLE_LUN(Handle) ((Handle) & 0xff)
...
WnbdCreateConnection(_In_ PGLOBAL_INFORMATION GInfo,
                     ...
                     _In_ PWNBD_DISK_HANDLE DiskHandle);
