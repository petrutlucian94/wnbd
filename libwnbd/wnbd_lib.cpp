...
DWORD WnbdGetUserspaceStats(
    ...
    PDWORD BufferSize)
{
    if (*BufferSize < sizeof(WNBD_USR_STATS)) {
        return ERROR_INSUFFICIENT_BUFFER;
    }

    memcpy(Stats, &Device->Stats, sizeof(WNBD_USR_STATS));
    *BufferSize = sizeof(WNBD_USR_STATS);
    ...
    PDWORD BufferSize)
{
    ...
    Status = WnbdIoctlStats(Handle, InstanceName, Stats, BufferSize);
